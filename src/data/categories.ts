...
export const categories: CategorySummary[] = [
  ...
  },
  {
    ...
    description:
      "Workforce expansion, formal payroll growth, central recruitment, unemployment trends and data limitations.",
    icon: "EW",
    metricCount: 5,
    period: "2004–2024",
    headlineMetric: {
    ...
    keywords: [
      ...
      "central recruitment",
      "plfs",
      "private sector limitation",
    ],
    sourceLabels: ["RBI KLEMS", "PIB", "EPFO", "PLFS", "SBI Ecowrap"],
  },
  {
    id: "economic-growth",
